...
public class TreeStuff
{
   ...
   /**
    * Utilizes our check height function to determine if a tree is balanced. In this case, a balanced tree is defined to
    * be a tree such taht the heights of the two subtrees of any node never differe by more than one.
    * 
    * @param root The root of our tree
